...
function NewGoalStats(props) {
    ...
    const [statSpec, setStatSpec] = useState({goal_id: goal.id, value: null, reporting_date: null})
        ...
        <div>
            {open && (
                <Dialog open={open} onClose={closeDialog} fullWidth maxWidth="md">
                    ...
                    <DialogContent>
                        <TextField required margin="dense" name='value' InputLabelProps={{shrink: true}}
                                   label='Goal Value' type='number' fullWidth onChange={handleChange}/>
                        <TextField required margin="dense" name='reporting_date' InputLabelProps={{shrink: true}}
                                   label='Date' type={calenderFormat} fullWidth onChange={handleChange}
                                   />
                    </DialogContent>
                    <DialogActions>
